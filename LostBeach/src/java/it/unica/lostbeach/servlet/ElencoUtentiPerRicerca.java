 ...
 * @author fpw
 */
@WebServlet(name = "ElencoUtentiPerRicerca", urlPatterns = {"/ElencoUtentiPerRicerca"})
public class ElencoUtentiPerRicerca extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Utente> utenti = UtenteFactory.getInstance().getAllUtenti();
        request.setAttribute("listaUtentiRicerca", utenti);
