 ...
 * @author fpw
 */
@WebServlet(name = "ElencoPrenotazioni", urlPatterns = {"/ElencoPrenotazioni"})
public class ElencoPrenotazioni extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /*Crea una lista con tutte le prenotazioni e setta un attributo con la lista creata*/
        ...
        request.getRequestDispatcher("compilazioneFatture.jsp").forward(request, response);
    }
